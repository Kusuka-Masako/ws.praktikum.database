...
import ws.praktikum.ws.praktikum.database.exceptions.NonexistentEntityException;
import ws.praktikum.ws.praktikum.database.exceptions.PreexistingEntityException;
...
public class AlattulisJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("ws.praktikum_ws.praktikum.database_jar_0.0.1-SNAPSHOTPU");
